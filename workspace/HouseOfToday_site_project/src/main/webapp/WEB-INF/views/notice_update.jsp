		...
		<div style="margin-top: 5px;">
			<form action="notice_update.do" method="post"
				...
				<input type="text" style="width: 100%;"
					name="ntitle" value="${ndto.ntitle}"/>
					<br>
				<label>내 용</label>
				<textarea rows="15" cols="100" name="ncontent" style="width: 100%">${ndto.ncontent}</textarea>
				...
				<br> <input type="text" value="<%=session.getAttribute("loginID")%>" name="mid"
					style="visibility: hidden;">
				<input type="text" name="date" value="<%=datestr%>"
					style="visibility: hidden;"> <br>
				<input type="text" value="${ndto.nid}" name="nid"
					style="visibility: hidden;">
